...
import { asyncGetDetailThread, getDetailThreadActionCreator, asyncCreateComment, createCommentActionCreator } from "../../src/app/states/detailThread/action"
...
describe("asyncGetDetailThread thunk", () => {
  ...
  it("should dispatch action correctly when data fetching success", async () => {
    ...
    expect(dispatch).toHaveBeenCalledWith(getDetailThreadActionCreator(fakeDetailThreadResponse))
